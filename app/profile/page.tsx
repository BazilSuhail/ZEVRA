          ...
          <div className="mx-auto max-w-2xl">
            ...
            >
              <div className="mb-6 flex items-center gap-6">
                <div className="flex h-24 w-24 items-center justify-center rounded-full bg-emerald-100 text-4xl font-bold text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400">
                  Y
                </div>
                <div>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-xl bg-zinc-50 p-4 dark:bg-zinc-800">
                  <div className="mb-2 flex items-center gap-2">
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400">Public Key</p>
                  </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.99 }}
                className="mt-6 flex items-center gap-2 rounded-xl bg-emerald-600 px-6 py-3 text-sm font-semibold text-white hover:bg-emerald-700"
              >
