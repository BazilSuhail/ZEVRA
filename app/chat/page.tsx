...
export default function ChatHomePage() {
  ...
  return (
    <>
      <div className="flex flex-1 flex-col items-center justify-center border-r border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              ...
              >
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-indigo-100 transition-colors group-hover:bg-indigo-200 dark:bg-indigo-900/40 dark:group-hover:bg-indigo-800/50">
                  <FiShield className="h-5 w-5 text-indigo-600 dark:text-indigo-400" />
                </div>
                <div>
